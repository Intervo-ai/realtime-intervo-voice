...
async function handleCallStopEvent(config, customParameters, callStartTime, conversationHistory, wss, ws, timer) {
    ...
    const phoneNumber = customParameters['phone-number'];

    if (!phoneNumber || !agentId) {
        console.error("Phone number or agent ID missing in custom parameters.");
        return;
    }
